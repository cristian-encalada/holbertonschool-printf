...
int main(void)
{
	...
	printf("Test 13");
	printf("\nexpected: ");
	a = printf("Testin%c percent", 'g');
	printf("\nobtained: ");
	fflush(stdout);
	b = _printf("Testin%c percent", 'g');
	cont = cont + output(a,b);
	printf("\n---------------\n");
	printf("Test 14");
	printf("\nexpected: ");
	a = printf("%c%c%c%c", 't', 'e', 's', 't');
	printf("\nobtained: ");
	fflush(stdout);
	b = _printf("%c%c%c%c", 't', 'e', 's', 't');
	cont = cont + output(a,b);
	printf("\n---------------\n");
	printf("Test 15");
	printf("\nexpected: ");
	...
	printf("Test 22");
	printf("\nexpected: ");
	a = printf("%s%c%c%c%c%s", "Pan ", 't', 'e', 's', 't', " Negative");
	printf("\nobtained: ");
	fflush(stdout);
	b = _printf("%s%c%c%c%c%s", "Pan ", 't', 'e', 's', 't', " Negative");
	cont = cont + output(a,b);
	printf("\n---------------\n");
	printf("Test 23");
	printf("\nexpected: ");
	a = printf("C%s Holberton%s", "20", "s");
	printf("\nobtained: ");
	fflush(stdout);
	b = _printf("C%s Holberton%s", "20", "s");
	cont = cont + output(a,b);
	printf("\n---------------\n");
	printf("Test 24");
	printf("\nexpected: ");
	a = printf("%s%", "Invalid_case");
	printf("\nobtained: ");
	fflush(stdout);
	b = _printf("%s%", "Invalid_case");
	cont = cont + output(a,b);
	printf("\n---------------\n");
	printf("Test 25");
	printf("\nexpected: ");
